...
public class ChatAdapter extends RecyclerView.Adapter<com.example.kissanapp.ChatAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new com.example.kissanapp.ChatAdapter.ViewHolder(view);
    }
