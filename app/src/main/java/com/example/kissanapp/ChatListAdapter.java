...
public class ChatListAdapter extends RecyclerView.Adapter<com.example.kissanapp.ChatListAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new com.example.kissanapp.ChatListAdapter.ViewHolder(view);
    }
